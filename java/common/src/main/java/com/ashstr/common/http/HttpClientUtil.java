package com.ashstr.common.http;
...
/**
 * @author keven
 * @date 2018-06-03 上午9:48
 * @Description http 请求get post
 */
@Slf4j
public class HttpClientUtil {
    ...
    public static String doGet(String url, Map<String, String> params, String charset) {
        ...
        try {
            ...
            log.error("fail send get request with params={}, cause={}", params,
    ...
    public static String doPost(String url, Map<String, String> params, String charset) {
        ...
        try {
            ...
            log.error("fail send post request with params={}, cause={}", params,
                    Throwables.getStackTraceAsString(e));
        }
        return null;
    }
    ...
    public static String doPost(String url, String json, String charset) {
        ...
        try {
            ...
            log.error("fail send post request with url={}, cause={}", url, Throwables.getStackTraceAsString(e));
        }
        return null;
    }
